...
//   }
//   // RSS beslemesi oluşturma işlemi
//   const rssFeed = `<?xml version="1.0" encoding="UTF-8"?>
//     <rss version="2.0">
//       <channel>
//         <title>${slug} Kategorisi RSS Beslemesi</title>
//         <link>Link to the category</link>
//         <description>RSS beslemesi için açıklama</description>
//         ${products
//           .map(
//             (product) => `
//               <item>
...
//                 <pubDate>${product?.publishedAt}</pubDate>
//                 <guid>${product?._id}</guid>
//               </item>
//             `
//           )
//           .join("")}
...
//   // Oluşturulan XML'i bir dosyaya yaz
//   try {
//     fs.writeFileSync(`./public/categories/${slug}/rss.xml`, rssFeed);
//   } catch (error) {
