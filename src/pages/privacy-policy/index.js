...
const PrivacyPolicyPage = () => {
  return (
    <div className="max-w-7xl px-5 md:px-14 mx-auto p-4 bg-white rounded-md shadow-md">
      ...
      <p className="mb-4">
        Links to third-party sites may lead to this web is beyond the control of
        the site. When you follow these links, the relevant the site's own
      ...
      <p className="mb-4">
        ...
        Accept the use of cookies You can adjust your browser settings to allow
        or refuse.
      </p>
      <p className="mb-4">
