    ...
    <div className="max-w-7xl mx-auto py-5 px-5 md:px-14">
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {categories?.map((category) => (
          <div className="dark:bg-white flex flex-col justify-center dark:text-black bg-zinc-900 font-bold text-white rounded-md py-4 px-6 text-center transition duration-300">
            <Link
